...
Il problema è $NPOC$ perché il suo problema di decisione associato è $NPC$.
...
Questa tecnica è molto comoda quando i problemi sono di natura esponenziale. Il numeri di problemi dipende dai valori dei parametri. Se i parametri sono nell'input del problema, la dimensione della tabella è esponenziale.
...
#proof()[
  ...
  Abbiamo ottenuto quindi $ sum_(i in X) v_i lt.eq sum_(i in overline(X)^*) + frac(epsilon v_max, 2) . quad (*) $
