...
Gli algoritmi deterministici che abbiamo usato fin'ora prendevano in input $x in I_Pi$ e restituivano un output $y in O_Pi$ in maniera totalmente deterministica.
...
L'algoritmo non è più deterministico: se conoscessimo a prescindere l'input e la porzione di _"nastro random"_ visitata potremmo simulare deterministicamente il comportamento, ma visto che non lo conosciamo il processo non è deterministico.
